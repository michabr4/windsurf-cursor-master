# ServiceFlow SDM — Instruction Log

> Running log of user-provided instructions, decisions, and context for the ServiceFlow SDM project.
...
- **Source file:** `ServiceFlow SDM/CLAUDE_md - ServiceFlow SDM Application Development Guide.msg`
