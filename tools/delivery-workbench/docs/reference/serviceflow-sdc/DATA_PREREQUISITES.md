# ServiceFlow SDM — Defined Data Prerequisites

> Extracted from: `CLAUDE_md - ServiceFlow SDM Application Development Guide.msg`
...
| Field | Value |
|---|---|
| Application | ServiceFlow SDM (Service Delivery Management Platform) |
