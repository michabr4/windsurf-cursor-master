...
### Ruby on Rails
- Avoid dangerous OS execution: `eval`, `system`, backtick expressions, `exec`, `spawn`, `open("| cmd")`, `Process.exec/spawn`, `IO.binread/binwrite/foreach/popen/read/readlines/write` with pipe-prefixed paths.
