...
If `.windsurf/handoff/STATE.md` exists, read it (and `LAST_SESSION_BRIEF.md`) **before** broad exploration. Continue the task; do not re-discover work already captured in the handoff.
